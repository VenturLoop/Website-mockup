...
const LaunchIcon = ({ className, isActive }) => (
  <svg className={className} viewBox="0 0 24 24" fill={isActive ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 12L7 7" />
    <path d="M12 12L17 7" />
     {isActive && <circle cx="12" cy="11" r="1" fill={isActive ? "white" : "currentColor"} />}
  </svg>
);
  ...
  return (
    <div className="android-frame animate-phone-float">
      <div className="mockup-screen">
        ...
        {/* App Header: Logo, App Name, and Founder Pass Button */}
        <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <InfinityLogo className="h-6 w-6 text-brand-blue mr-2" />
              <span className="text-lg font-semibold text-brand-blue">VenturLoop</span>
            </div>
        ...
        <div className="flex-grow overflow-y-auto px-4 py-4 hide-scrollbar">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow hover:shadow-lg transition-shadow duration-200 flex flex-col items-center text-center">
              ...
              <h3 className="text-xs font-semibold text-gray-800 dark:text-white">Find a Co-founder</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-tight">Connect with like-minded innovators</p>
            </div>

            {/* Tile 2: Find Investors */}
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow hover:shadow-lg transition-shadow duration-200 flex flex-col items-center text-center">
              <InvestorIcon className="w-8 h-8 text-brand-green mb-2" />
              <h3 className="text-xs font-semibold text-gray-800 dark:text-white">Find Investors</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-tight">Secure funding for your venture</p>
            </div>

            {/* Tile 3: Join a Community */}
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow hover:shadow-lg transition-shadow duration-200 flex flex-col items-center text-center">
              <CommunityIcon className="w-8 h-8 text-brand-purple mb-2" />
              <h3 className="text-xs font-semibold text-gray-800 dark:text-white">Join a Community</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-tight">Network with peers and mentors</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow hover:shadow-lg transition-shadow duration-200 flex flex-col items-center text-center relative">
              <div className="absolute top-1 right-1 bg-red-500 text-white text-[0.625rem] leading-none px-1.5 py-0.5 rounded-full">New</div>
              <AcceleratorIcon className="w-8 h-8 text-brand-orange mb-2" />
              <h3 className="text-xs font-semibold text-gray-800 dark:text-white">Find Accelerators</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-tight">Fast-track your startup growth</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow hover:shadow-lg transition-shadow duration-200 flex flex-col items-center text-center relative">
              ...
              <h3 className="text-xs font-semibold text-gray-800 dark:text-white">Find Incubator</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-tight">Nurture your idea from scratch</p>
            </div>

            {/* Tile 6: Help & Support */}
            <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow hover:shadow-lg transition-shadow duration-200 flex flex-col items-center text-center">
              <HelpIcon className="w-8 h-8 text-gray-500 dark:text-gray-400 mb-2" />
              <h3 className="text-xs font-semibold text-gray-800 dark:text-white">Help & Support</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-tight">Get assistance and find resources</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-around items-center py-2 px-2 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 mt-auto">
          ...
          <button className="flex flex-col items-center text-brand-blue dark:text-brand-blue hover:opacity-75 transition-opacity px-2">
            <LaunchIcon className="w-5 h-5 mb-0.5" isActive={true} />
            <span className="text-xs font-medium">Launch</span>
          </button>

          {/* Nav Item 2: Community */}
          <button className="flex flex-col items-center text-gray-500 dark:text-gray-400 hover:text-brand-blue dark:hover:text-brand-blue-light transition-colors px-2">
          ...
          {/* Nav Item 4: Message */}
          <button className="relative flex flex-col items-center text-gray-500 dark:text-gray-400 hover:text-brand-blue dark:hover:text-brand-blue-light transition-colors px-2">
            <MessageIcon className="w-5 h-5 mb-0.5" />
            <span className="text-xs font-medium">Message</span>
            {/* Notification Badge */}
            <span className="absolute top-0 right-1 w-3 h-3 bg-red-500 text-white text-[0.5rem] leading-none flex items-center justify-center rounded-full border-1 border-white dark:border-gray-800">
              1
            </span>
          </button>
