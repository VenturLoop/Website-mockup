...
// LinkedIn Icon
const LinkedInIcon = () => (
  <svg className="w-6 h-6 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
  </svg>
);

// Colored Circle Icons for Match Score
const YellowCircleIcon = () => (<div className="w-3 h-3 bg-yellow-400 rounded-full mr-2 shrink-0"></div>);
const GreenCircleIcon = () => (<div className="w-3 h-3 bg-green-400 rounded-full mr-2 shrink-0"></div>);
const RedCircleIcon = () => (<div className="w-3 h-3 bg-red-400 rounded-full mr-2 shrink-0"></div>);
      ...
      <div className="android-frame animate-phone-float">
        <div className="mockup-screen relative">
          ...
          <div className="flex-grow overflow-y-auto hide-scrollbar pb-20">
            {activeView === 'Co-founder' && (
              <>
                <div className="border-b border-android-border-light dark:border-android-border-dark"> {/* Wrapper for Co-founder content sections */}
                  ...
                  <div className="w-16 h-16 bg-gray-300 rounded-full flex items-center justify-center dark:bg-gray-700">
                    {/* Optional: User icon can be added here */}
                  </div>
                  {/* Text Info */}
                  <div>
                ...
                <div className="px-4 py-3 flex justify-between items-center"> {/* No bottom border here, as the main wrapper div has it */}
                ...
                <div className="px-4 py-3">
                  <p className="text-base text-gray-800 dark:text-gray-200">
                    Full Stack Web Developer | Graphic Designer | Exploring UI/UX
                  </p>
                </div>
                ...
                <div className="px-4 py-3">
                  <div className="flex items-center mb-2">
                    <UserIcon />
                    <span className="text-sm text-gray-600 dark:text-gray-400 w-20">Age:</span>
                    <span className="text-sm text-gray-800 dark:text-gray-200">25</span>
                  </div>
                  <div className="flex items-center mb-2">
                    <LocationPinIcon />
                    <span className="text-sm text-gray-600 dark:text-gray-400 w-20">Location:</span> {/* Icon already has mr-2 */}
                    <span className="text-sm text-gray-800 dark:text-gray-200">Yavatmal</span>
                  </div>
                  <div className="flex items-center">
                    <CalendarIcon />
                    <span className="text-sm text-gray-600 dark:text-gray-400 w-20">Joined:</span>
                    <span className="text-sm text-gray-800 dark:text-gray-200">Feb 2025</span>
                  </div>
                </div>
                ...
                {activeCoFounderTab === 'About' && (
                  <div className="p-4 text-sm">
                    <div className="mb-3">
                      <p className="font-semibold text-gray-700 dark:text-gray-300">Commitment Level</p>
                      <p className="text-gray-600 dark:text-gray-400">Ready to go full time next year</p>
                    </div>
                    <div className="mb-3">
                      <p className="font-semibold text-gray-700 dark:text-gray-300">Prior Experience</p>
                      <p className="text-gray-600 dark:text-gray-400">Worked in a startup</p>
                    </div>
                    <div>
                      <p className="font-semibold text-gray-700 dark:text-gray-300">Equity Expectation</p>
                      <p className="text-gray-600 dark:text-gray-400">Around 30% – 70%</p>
                    </div>
                  </div>
                )}
                 {activeCoFounderTab === 'Experience' && <div className="p-4 text-sm text-gray-700 dark:text-gray-300">Experience Content Placeholder. Yash's past roles, projects, and achievements.</div>}
                 {activeCoFounderTab === 'Projects' && <div className="p-4 text-sm text-gray-700 dark:text-gray-300">Projects Content Placeholder. Showcase of personal or professional projects undertaken by Yash.</div>}
              </>
            )}
            ...
            {activeView === 'Co-founder' && (
              <div className="absolute bottom-4 left-0 right-0 flex justify-center z-10">
                <div className="flex space-x-2 bg-gray-800 bg-opacity-75 p-1.5 rounded-full shadow-lg">
                  <button aria-label="Bookmark profile" className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center p-2 shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">
                    <StarIcon />
                  </button>
                  <button aria-label="Skip profile" className="w-10 h-10 bg-red-500 rounded-full flex items-center justify-center p-2 shadow-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-opacity-75">
                    <CrossIcon />
                  </button>
                  <button aria-label="Request to connect" className="w-10 h-10 bg-teal-500 rounded-full flex items-center justify-center p-2 shadow-md hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-opacity-75">
                    <UsersIcon />
                  </button>
                  <button aria-label="Send message" className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center p-2 shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75">
                    <EnvelopeIcon />
                  </button>
                </div>
              </div>
            ...
            {activeView === 'Investor' && (
              <div className="absolute bottom-4 left-0 right-0 flex justify-center z-10">
                <div className="flex space-x-2 bg-gray-800 bg-opacity-75 p-1.5 rounded-full shadow-lg"> {/* Adjusted space and padding */}
                  <button aria-label="Save profile" className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center p-2 shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"> {/* Adjusted size and padding */}
                    <StarIcon />
                  </button>
                  <button aria-label="Dismiss profile" className="w-10 h-10 bg-red-500 rounded-full flex items-center justify-center p-2 shadow-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-opacity-75"> {/* Adjusted size and padding */}
                    <CrossIcon />
                  </button>
                  <button aria-label="Send message" className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center p-2 shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75"> {/* Adjusted size and padding */}
                    <EnvelopeIcon />
                  </button>
                  <button aria-label="Pin profile" className="w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center p-2 shadow-md hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-opacity-75"> {/* Adjusted size and padding */}
                    <PinIcon />
                  </button>
                </div>
              </div>
